...
import me.glennEboy.Walls.utils.PlayerUidChecker;
...
public class WallsCmd implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
    	...
    	}else if (args[0].equalsIgnoreCase("migratevips")){
    		migrateVips(sender, cmd, commandLabel, args);
...
//       			myWalls.myDB.setSCBPro(args[1], (twp.pro) ? 1 : 0);
    ...
    private void migrateVips(CommandSender sender , Command cmd, String commandLabel, String[] args) {
    	if (sender.isOp()){

    		myWalls.myDB.addUIDToWalls();
    	}
    }
