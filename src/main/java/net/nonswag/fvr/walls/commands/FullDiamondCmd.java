...
import net.nonswag.fvr.walls.kits.FullChainKit;
import net.nonswag.fvr.walls.kits.FullDiamondKit;
import net.nonswag.fvr.walls.kits.FullGoldKit;
...
public class FullDiamondCmd implements CommandExecutor{
    ...
    public static void fullChain(Walls myWalls){
        Notifier.broadcast("T'Dah! You are now "+ChatColor.DARK_GRAY+"STACKED!");
    ...
    public static void fullGold(Walls myWalls){
        Notifier.broadcast("T'Dah! You are now "+ChatColor.GOLD+"STACKED!");
