				...
				(y >= 14))
		{
			...
			for (int z2 = 0; z2 < 3; z2++) {
				for (int y2 = 1; y2 < 4; y2++) {
					chunk.getBlock(x, y + 1 + y2, z + z2).setType((z2 == 0) || (z2 == 2) ? Material.NETHER_BRICK : Material.NETHER_BRICK);
					if ((z2 == 1) && (y2 == 2)) chunk.getBlock(x, y + 1 + y2, z + z2).setType(Material.NETHER_FENCE);
					if (y2 != 3) continue; chunk.getBlock(x - 1, y + 1 + y2, z + z2).setTypeIdAndData(Material.NETHER_BRICK_STAIRS.getId(), (byte) 0, false);
				}
			...
			for (int z2 = 0; z2 < 3; z2++) {
				for (int y2 = 1; y2 < 4; y2++) {
					chunk.getBlock(x + 2, y + 1 + y2, z + z2).setType((z2 == 0) || (z2 == 2) ? Material.NETHER_BRICK : Material.NETHER_BRICK);
					if ((z2 == 1) && (y2 == 2)) chunk.getBlock(x + 2, y + 1 + y2, z + z2).setType(Material.NETHER_FENCE);
					if (y2 != 3) continue; chunk.getBlock(x + 3, y + 1 + y2, z + z2).setTypeIdAndData(Material.NETHER_BRICK_STAIRS.getId(), (byte) 1, false);
				}
			...
			for (int x2 = 0; x2 < 3; x2++) {
				for (int y2 = 1; y2 < 4; y2++) {
					...
					if (y2 != 3) continue; chunk.getBlock(x + x2, y + 1 + y2, z - 1).setTypeIdAndData(Material.NETHER_BRICK_STAIRS.getId(), (byte) 2, false);
				}
...
//			chunk.getBlock(x + 1, y + 3, z + 2).setTypeIdAndData(Material.WOODEN_DOOR.getId(), (byte) 8, false);
			...
			for (int x2 = 0; x2 < 3; x2++) {
				for (int y2 = 1; y2 < 4; y2++) {
					if (y2 != 3) continue; chunk.getBlock(x + x2, y + 1 + y2, z + 3).setTypeIdAndData(Material.NETHER_BRICK_STAIRS.getId(), (byte) 3, false);
				}
