...
public class ChestPopulator extends BlockPopulator {
    ...
    public static final Material FLOOR_MATERIAL = Material.SAND;
    public static final int[] CHANCES = new int[] { 5, 40, 70, 99, 100 };
    public static final Material[] REWARD_MATERIALS = new Material[] { Material.WOOD_PICKAXE, Material.WOOD_SWORD, Material.STONE_PICKAXE, Material.STONE_SWORD, Material.GOLD_PICKAXE, Material.GOLD_SWORD, Material.LEATHER_BOOTS, Material.LEATHER_CHESTPLATE, Material.LEATHER_HELMET, Material.LEATHER_LEGGINGS, Material.IRON_BOOTS, Material.IRON_CHESTPLATE, Material.IRON_HELMET, Material.IRON_LEGGINGS, Material.ARROW, Material.STRING, Material.BONE, Material.APPLE, Material.COOKIE, Material.RAW_FISH, Material.COOKED_FISH, Material.PORK, Material.GRILLED_PORK };
    public static final Material[] RARE_REWARDS = new Material[] { Material.IRON_PICKAXE, Material.IRON_SWORD, Material.DIAMOND_PICKAXE, Material.DIAMOND_SWORD, Material.GOLD_BOOTS, Material.GOLD_CHESTPLATE, Material.GOLD_HELMET, Material.GOLD_LEGGINGS, Material.DIAMOND_BOOTS, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET, Material.DIAMOND_LEGGINGS, Material.GOLDEN_APPLE, Material.BOW, Material.FISHING_ROD };
    ...
    public void populate(World world, Random random, Chunk source) {
        if (true)
            return;
        /*	// Is this even a desert type continent?
        	int conx = Continent.getContinentFromChunk(source.getX());
        	int conz = Continent.getContinentFromChunk(source.getZ());
        	
        	Continent continent = ContinentManager.getInstance(world.getName()).getContinent(world, conx, conz);
        	
        	// Don't do anything if it's not an desert-type continent
