...
public class HugeMushroomPopulator extends BlockPopulator {
    ...
    public void grow(World world, Random random, int i, int j, int k) {
                ...
                for (int k1 = i - b0; (k1 <= i + b0) && (flag); k1++) {
                    for (int l1 = k - b0; (l1 <= k + b0) && (flag); l1++) {
                        if ((j1 >= 0) && (j1 < 256)) {
                            ...
                            if ((i2 != 0) && (i2 != Material.LEAVES.getId())) flag = false;
                        } else flag = false;
                    }
                }
            }
            ...
            for (int k1 = j2; k1 <= j + i1; k1++) {
                ...
                for (int i2 = i - l1; i2 <= i + l1; i2++) {
                    for (int k2 = k - l1; k2 <= k + l1; k2++) {
                        ...
                        if (k2 == k + l1) l2 += 3;
                        if ((l == 0) || (k1 < j + i1)) {
                            if (((i2 == i - l1) || (i2 == i + l1)) && ((k2 == k - l1) || (k2 == k + l1))) continue;
                            if ((i2 == i - (l1 - 1)) && (k2 == k - l1)) l2 = 1;
                            if ((i2 == i - l1) && (k2 == k - (l1 - 1))) l2 = 1;
                            if ((i2 == i + (l1 - 1)) && (k2 == k - l1)) l2 = 3;
                            if ((i2 == i + l1) && (k2 == k - (l1 - 1))) l2 = 3;
                            if ((i2 == i - (l1 - 1)) && (k2 == k + l1)) l2 = 7;
                            if ((i2 == i - l1) && (k2 == k + (l1 - 1))) l2 = 7;
                            if ((i2 == i + (l1 - 1)) && (k2 == k + l1)) l2 = 9;
                            if ((i2 == i + l1) && (k2 == k + (l1 - 1))) l2 = 9;
                        }
                        if ((l2 == 5) && (k1 < j + i1)) {
                            l2 = 0;
                        }
