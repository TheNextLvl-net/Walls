...
public class NetherBiome extends WorldFiller {
    ...
    public NetherBiome(World world, int minX, int minZ, int maxX, int maxZ, int startY, int groundLevel) {
        ...
        this.addPopulator(new NetherHutPopulator(), true);
        this.addPopulator(new NetherPopulator());
        this.addPopulator(new NetherTreePopulator(NetherTreePopulator.Type.SAVANNA));
        this.addPopulator(new LapisRingPopulator());
    }
