...
public class CavePopulator extends BlockPopulator {
    ...
    public CavePopulator(Container filler) {
        this.filler = filler;
    }
    ...
    public void populate(World world, Random random, Chunk chunk) {
        /*// Is this even on a continent we want to use it one?
        ...
        if(!(continent.getType() == ContinentType.DEFAULT || continent.getType() == ContinentType.PLAINSTONE))
            return;*/
